				...
				<td>
					<table class="search-table top-color">
						...
						<tr>
							<th>수정자</th>
							<td>
								<input type="text" class="AXInput w200px" name="modifier" id="modifier" readonly="readonly">
...
// 								var url = "/Windchill/platform/util/folder?location=/Default&target=&context=";
