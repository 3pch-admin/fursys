...
<script type="text/javascript">
	...
	AUIGrid.bind(rightGridID, "contextMenu", function(event) {
		...
		if (event.dataField == "partName" || "erpCode") {
			var item = event.item;
			// 			if (item.state == "릴리즈됨") {
			// 				return false;
			// 			}
...
// 		})
	...
	function loadLeft() {
		loadLeftTree("/Windchill/jsp/mbom/mockup/mbom-reference-left.json");
	}
	function loadRight() {
		loadRightTree("/Windchill/jsp/mbom/mockup/mbom-reference-right.json");
	}
