...
<script type="text/javascript">
	function loadRightTree(oid) {
		$("#treeRight").fancytree({
			...
			debugLevel : 0,
			source : {
				url : "/Windchill/platform/ebomMaster/load?oid=" + oid
...
<%}%>
			...
			contextMenu : {
				...
				actions : function(node, action, options) {
					...
					if (action == "expands") {
						...
						var url = "/Windchill/platform/part/append?partTypeCd=" + node.data.partTypeCd + "&ref=" + ref;
						_popup(url, 1200, 360, "n");
					} else if (action == "top") {
						var url = "/Windchill/platform/part/top?partTypeCd=" + node.data.partTypeCd + "&ref=" + ref;
						_popup(url, 1200, 360, "n");
					} else if (action == "exist") {
						var url = "/Windchill/platform/part/exist?box=1&partTypeCd=" + node.data.partTypeCd + "&ref=" + ref;
						_popup(url, "", "", "f");
					}
				}
			}
	...
	// 	function calculation(node, amount) {
	// 		console.log(node);
	// 		for (var i = 0; node.parent != null) {
