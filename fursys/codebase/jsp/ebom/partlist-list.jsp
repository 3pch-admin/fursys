...
// 							width : 150
						...
						AUIGrid.bind(myGridID, "cellClick", function(event) {
							...
							if (dataField == "number") {
								var url = _url("/ebomMaster/pview", rowItem.oid);
								_popup(url, "", "", "f");
							} else if (dataField == "ecoNumber") {
								if (rowItem.eoid == "") {

									return false;
								}
								var url = _url("/eco/view", rowItem.eoid);
								_popup(url, "", "", "f");
						...
						$(function() {
							...
							$("#deleteBtn").click(function() {
								...
								var url = _url("/ebomMaster/delete", oid);
