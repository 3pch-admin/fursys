		...
		<td>
			<table class="search-table top-color">
				...
				<tr>
					...
					<td>
						<label>
							<input type="radio" name="latest" value="true" checked="checked">최신버전
						</label>
						&nbsp;
						<label>
							<input type="radio" name="latest" value="false">모든버전
						</label>
					</td>
					<th>부품유형</th>
					<td colspan="3">
						<label>
							<input type="radio" name="partType" value="ALL" checked="checked">전체
						</label>
						<label>
							<input type="radio" name="partType" value="SET">세트
						</label>
						<label>
							<input type="radio" name="partType" value="ITEM">단품
						</label>
						<label>
							<input type="radio" name="partType" value="MAT">자재
						</label>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<label>
							<input type="radio" name="attr" value="true">자재속성
						</label>
						&nbsp;
						<label>
							<input type="radio" name="attr" value="false">설계속성(공통)
						</label>
						&nbsp;
						<label>
							<input type="radio" name="attr" value="hide">숨김
						</label>
					</td>
					<th>작성일자</th>
					<td>
