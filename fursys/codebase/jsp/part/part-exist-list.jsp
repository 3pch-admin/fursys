	...
	<tr>
		...
		<td>
			...
			<table class="button-table">
				<tr>
					<td class="right">
						<button type="button" class="addBtn" data-apply="s">적용</button>
						<button type="button" class="addBtn" data-apply="m">추가</button>
...
// 					usePaging : true
				...
				$(function() {
					...
					$(".addBtn").click(function() {
						...
						var partType= items[0].item.partType;

						if("<%=partTypeCd%>" == "ITEM") {
							if(partType == "세트" || partType == "단품") {
								alert("단품 아래에 세트/단품은 추가는 불가능합니다.");
								return false;
							}
						}
						...
						var type = $(this).data("apply");
						var params = new Object();
						params.oid = items[0].item.oid;
						var url = _url("/part/exist");
						_call(url, params, function(data) {
