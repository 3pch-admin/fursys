...
<%@page import="platform.mbom.entity.MBOMEBOMLink" %>
...
QueryResult result = PersistenceHelper.manager.navigate(eco, "header", MBOM.class);
if (result.hasMoreElements()) {
	header = (MBOM) result.nextElement();
...
<br>
<table class="create-table mbom close" id="_tree">
	<colgroup>
		<col width="40">
		<col width="400">
		<col width="180">
