...
EPMDocumentType[] docTypes = EPMDocumentType.getEPMDocumentTypeSet();
%>
				...
				<tr>
					...
					<td colspan="3">
						<select name="docType" id="docType" class="AXSelect w200px">
							...
							<%
							for (EPMDocumentType docType : docTypes) {
							%>
			...
			<%}%>
				...
				$(function() {
					...
					$("#addBtn").click(function() {
						...
						if (items.length == 0) {
							alert("추가 할 도면을 선택하세요.");
							return false;
						}
						var list = _array(items);
						var params = new Object();
						params.list = list;
						var url = _url("/epm/info");
						_call(url, params, function(data) {
							opener.epm(data.info);
							self.close();
						}, "POST");
					})
