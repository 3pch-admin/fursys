...
<body onload="load();" id="container">
	<form id="form">
		...
		<div class="header-title">
			<img src="/Windchill/jsp/images/home.png" class="home"> <span>HOME</span> > <span>라이브러리 컬러셋</span> > <span>라이브러리 컬러셋 조회</span>
		</div>
		<table id="wrap-table">
			<tr>
				<td>
					<table class="search-table top-color">
						...
						<tr>
							<th>부품번호</th>
							<td><input type="text" name="number" class="AXInput w60p"></td>
							<th>부품명</th>
							<td><input type="text" name="ecoNumber" class="AXInput w60p"></td>
						</tr>
					</table>
					...
					<div id="grid_wrap" style="height: 715px;"></div>
					<div id="grid_paging" class="aui-grid-paging-panel my-grid-paging-panel"></div> <script type="text/javascript">
						var myGridID;
						var totalRowCount;
