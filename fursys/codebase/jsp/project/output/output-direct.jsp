...
<table class="create-table">
	...
	<tr>
		...
		<td colspan="3">
			<input type="text" class="AXInput w70p" readonly="readonly" value="<%=location%>" name="location" id="location">
		</td>
	</tr>
	<tr>
		<th>
...
<script type="text/javascript">
	$(function() {
		...
		// 			var url = "/Windchill/platform/util/folder?location=/Default/Document&target=&callBack=raonk";
